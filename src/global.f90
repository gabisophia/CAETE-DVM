...
module global_par
   ...
   real(r_4),parameter,public :: vuln_curve = 3                  ! Gravity (m/s2)
   ...
   integer(i_4),parameter,public :: npls = 700                   ! Number of Plant Life Strategies-PLSs simulated (Defined at compile time)
