...
contains
   ...
   function soil_waterpotential(w, wmax) result(psi_soil)
      ...
      use types
      use global_par, only: psisat, soiltext
...
!      real(r_8),intent(in) :: soil_texture        !dimensionless - coefficient soil texture
      ...
      psi_soil = psisat * wa ** (-soiltext)
   end function soil_waterpotential

   !=================================================================
   !=================================================================

!   function psi_fifty(dwood) result(psi_50)
...
!      real(r_8),intent(in) :: dwood            !g/cm3 - wood sendity
!      real(r_8) :: psi_50                       !MPa
...
!   function conductivity_xylemleaf(dwood,amax) result(kl_max)
